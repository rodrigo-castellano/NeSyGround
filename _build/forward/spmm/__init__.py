...
"""
from grounder._build.forward.spmm.kernels import apply_spmm_rule, apply_spmm_rule_slots
from grounder._build.forward.spmm.matrices import build_pred_sparse_matrices
from grounder._build.forward.spmm.ops import SpMMOp, SpMMRuleDesc, classify_rule
from grounder._build.forward.spmm.runner import run_forward_chaining_spmm
from grounder._build.forward.spmm.state import ClosureState, TransposeCache
from grounder._build.forward.spmm.strategies import (
