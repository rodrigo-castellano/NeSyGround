...
from grounder._build.forward.spmm.kernels import apply_spmm_rule_slots
from grounder._build.forward.spmm.matrices import (
...
from grounder._build.forward.spmm.state import ClosureState
...
def run_forward_chaining_spmm(
    ...
    *,
    ...
    Returns:
        ...
        :func:`grounder._build.forward.fc.run_forward_chaining`. Hashes are the
