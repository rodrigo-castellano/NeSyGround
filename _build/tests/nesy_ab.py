"""A/B parity test: grounder._build.nesy.* vs grounder.nesy.* (OLD).
...
Usage:
    python _build/tests/nesy_ab.py
"""
...
# ── Import NEW symbols ──────────────────────────────────────────────────────
from grounder._build.nesy.hooks import (
...
from grounder._build.nesy.scoring import (
    PartialScorer as NEW_PartialScorer,
    LazyPartialScorer as NEW_LazyPartialScorer,
)
from grounder._build.nesy.kge import (
...
from grounder._build.nesy.neural import (
    GroundingAttention as NEW_GroundingAttention,
    NeuralScorer as NEW_NeuralScorer,
)
from grounder._build.nesy.soft import (
    ProvabilityMLP as NEW_ProvabilityMLP,
    SoftScorer as NEW_SoftScorer,
)
from grounder._build.nesy.sampler import RandomSampler as NEW_RandomSampler
from grounder._build.nesy import _topk_select as NEW_topk_select
