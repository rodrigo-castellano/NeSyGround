...
Usage:
    python _build/tests/fc_fingerprint.py            # check all cells
    python _build/tests/fc_fingerprint.py --cell family|spmm|d10
    python _build/tests/fc_fingerprint.py --write     # (re)write the baseline
"""
...
_BASELINE = (_HERE.parent.parent / "tests" / "baselines" / "fc_fingerprint.json")
