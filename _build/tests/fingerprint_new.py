...
Usage:
    python _build/tests/fingerprint_new.py            # check all 14
    python _build/tests/fingerprint_new.py --cell family|SLD|d3
"""
...
_BASELINE = (_HERE.parent.parent / "tests" / "baselines" / "ground_fingerprint.json")
