...
from grounder.backward import state as state_mod
from grounder import types as types_mod
from grounder.core import request as request_mod
from grounder.glossary import FIELDS
...
def test_glossary_fields_token_disjoint() -> None:
    ...
    from grounder.glossary import GLOSSARY
...
def test_shape_symbols_match_vocab() -> None:
    ...
    from grounder.glossary import SHAPES
