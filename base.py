...
class Grounder(nn.Module):
    ...
    Args:
        ...
        fact_order:         'original' | 'shuffle' — fact ordering within
                            each predicate group (matters when K_f caps results)
        rule_order:         'original' | 'shuffle' — rule ordering within
                            each head-predicate group (matters when K_r caps)
    ...
    def __init__(
        ...
        *,
        ...
        # --- Build indices (buffers live on the submodules) ---
